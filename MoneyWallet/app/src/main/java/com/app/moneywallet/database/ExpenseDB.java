...
public class ExpenseDB extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "ExpenseInfo";
    ...
    public void onCreate(SQLiteDatabase sqLiteDB) {
        try {
            sqLiteDB.execSQL(
                    "CREATE TABLE " + TABLE_NAME + "(id INTEGER PRIMARY KEY, amount INTEGER, category text)"
            );
    ...
    @SuppressLint("Range")
    public ArrayList<IncomeInfo> getAllExpense() {
